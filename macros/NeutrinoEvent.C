...
void ReadFile(const std::string &inputFileName, NeutrinoEventVector &nuEventVector)
{
    ...
    tree->SetBranchAddress("SelShowerPandrizzledEdxBestPlane", &nu.m_selShowerdEdxBestPlane);
    tree->SetBranchAddress("SelTrackPandizzleVar", &nu.m_selTrackPandizzleScore);
    //tree->SetBranchAddress("SelShowerBackupPandrizzleScore", &nu.m_selShowerPandrizzleScore);
    //tree->SetBranchAddress("SelShowerEnhancedPandrizzleScore", &nu.m_selShowerJamPandrizzleScore);
